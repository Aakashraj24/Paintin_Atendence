myData = [
    ...
    { "date": "2026-03-13T00:00:00Z", "atd": 1, "adv": 0 },
    { "date": "2026-03-14T00:00:00Z", "atd": 1, "adv": 0 },
    { "date": "2026-03-15T00:00:00Z", "atd": 1, "adv": 0 },
    { "date": "2026-03-16T00:00:00Z", "atd": 1, "adv": 0 },
...
function json_to_table_data(jsonList) {
    ...
    for (let value of myData) {
        ...
        if (atd == 0 && adv == 0) {
            ...
            tds = `<tr><td class="date" width="20%">${dtc.split(" : ")[2]}</td><td class="atd">---</td><td class="adv">${adv = adv ? "₹"+adv : "---"}</td><td class="available">₹${total_available}</td></tr>`
        } else {
